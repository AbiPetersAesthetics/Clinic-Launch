...
const CHANNELS: Record<string, { label: string; icon: React.ElementType; where: string; bar: string; dot: string; text: string }> = {
  ...
  email:  { label: "Message",icon: Mail,       where: "email + WhatsApp (GHL)", bar: "border-l-blue-400",   dot: "bg-blue-500",   text: "text-blue-600 dark:text-blue-300" },
