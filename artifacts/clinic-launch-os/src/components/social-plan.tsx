...
import { Instagram, Video, Camera, CheckCircle2, Circle, Repeat, ShieldCheck, Star, ChevronDown, ChevronRight } from "lucide-react";
...
// Ready-to-post calendar. Each post carries: place (Post or Story), media (Reel,
// Carousel or Image), category, a title, an overview (how to shoot it) and the
// finished caption. Compliant: no POM named, no discounts, results carry consent
// and the "one person's result" caveat. [Date] and [Client words] are the only
// things to fill in before posting.
const CALENDAR = [
  { wc: "w/c 14 September", phase: "Reboot and Bedhampton harvest", posts: [
    { d: "Mon", place: "Post", media: "Reel", slot: "Educate", title: "The one thing before any treatment", idea: "Abi to camera, talking head.", cap: "Before I recommend a single treatment, I do one thing: a proper skin analysis. Clinical imaging that shows what is happening beneath the surface, so your plan rests on evidence, not guesswork. Free at my Bedhampton clinic right now. Comment ANALYSIS or tap the link. #NurseLedAesthetics #HampshireSkin #SkinHealth" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Meet Abi", idea: "Fresh intro: 16 years, prescriber, Winchester coming.", cap: "Hi, I am Abi. I trained as a nurse before I ever touched skin, and 16 years on it still shapes everything: safety first, honesty always, natural over overdone. This autumn I am opening my own clinic in Winchester, and I would love you to follow along. #NurseLed #WinchesterAesthetics #AbiPetersSkinClinic" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Your free first step", idea: "Simple offer graphic, scanner not shown yet.", cap: "Your skin, properly looked at, on me. A free skin analysis is the honest first step: no pressure, and nothing sold on the day. At my Bedhampton clinic until the end of October. Book ahead, link in bio. #FreeSkinAnalysis #Bedhampton #HonestAdvice" },
  ]},
  { wc: "w/c 21 September", phase: "Reboot and Bedhampton harvest", posts: [
    { d: "Mon", place: "Post", media: "Carousel", slot: "Educate", title: "What a skin booster actually is", idea: "3 to 4 slide explainer.", cap: "Skin boosters, what actually are they? Not filler, they do not change your shape. Think a deep drink of water for your skin, hydration that helps it look fresher from within. Not right for everyone, which is why I start with an analysis. Curious? Link in bio. #SkinBoosters #HampshireSkin #SkinHealth" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Where Winchester is up to", idea: "Countdown, not a reveal. Room in progress.", cap: "You know Winchester is coming, so here is where we are up to. The unit on Jewry Street is becoming somewhere calm and considered, every detail chosen so you feel at ease the second you walk in. Opening 2 November. #WinchesterAesthetics #ComingSoon #Winchester" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "The honest first step", idea: "Offer graphic with the DM prompt.", cap: "No hard sell, ever. Just an honest look at your skin and a plan that fits you. The free skin analysis is booking now at Bedhampton until the end of October. Tap the link or DM me SKIN. #FreeSkinAnalysis #HonestAdvice #Bedhampton" },
  ]},
  { wc: "w/c 28 September", phase: "Reboot, scanner now in", posts: [
    { d: "Mon", place: "Post", media: "Reel", slot: "Educate", title: "Nurse-led vs the high street", idea: "Your strongest angle, Abi to camera.", cap: "The real difference in medical aesthetics is the part you cannot see on Instagram. As a nurse and prescriber, the assessment and the honest no when a treatment is not right for you are where the safety lives. That is what nurse-led actually means. #NurseLedAesthetics #MedicalAesthetics #HampshireSkin" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Behind the scenes fit-out", idea: "B-roll of the room plus voiceover.", cap: "A little behind the scenes. The Winchester clinic is coming together and I cannot quite believe it. Save this and follow along, the countdown is on. #WinchesterAesthetics #BehindTheScenes #ComingSoon" },
    { d: "Fri", place: "Post", media: "Reel", slot: "Proof", title: "What the scan shows", idea: "The analyser in action (now in the room).", cap: "This is what your free skin analysis actually shows: what is happening beneath the surface, not just what the eye sees. It is why your plan is built on evidence. Free at Bedhampton until the end of October, book ahead. #SkinAnalysis #FreeSkinAnalysis #SkinHealth" },
  ]},
  { wc: "w/c 5 October", phase: "Countdown", posts: [
    { d: "Mon", place: "Post", media: "Carousel", slot: "Educate", title: "Facials and peels", idea: "Broaden beyond lips. Who each suits.", cap: "Not everyone needs an injectable. Sometimes the honest answer is a medical-grade facial or a peel to get your skin healthy first. Skin health before anything else, always. Book an analysis and let us find out what yours needs. #MedicalFacial #ChemicalPeel #SkinHealth" },
    { d: "Wed", place: "Post", media: "Image", slot: "Human", title: "Four weeks to go", idea: "Room progress photo, countdown caption.", cap: "Four weeks to go. The Winchester room is nearly there. Opening Monday 2 November on Jewry Street. #Winchester #ComingSoon #WinchesterAesthetics" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Last weeks, free analysis", idea: "Deadline graphic (closes end of Oct).", cap: "The free skin analysis at Bedhampton closes at the end of October, then the scanner moves to Winchester. If you have been meaning to book your honest first step, now is the time. Link in bio. #FreeSkinAnalysis #Bedhampton #LastChance" },
  ]},
  { wc: "w/c 12 October", phase: "Countdown and founding teaser", posts: [
    { d: "Mon", place: "Post", media: "Reel", slot: "Educate", title: "Microneedling, what to expect", idea: "Fresh angle, calm walk-through.", cap: "What actually happens in a microneedling appointment, and why it works with your skin rather than against it. Calm, clinical, and always after a proper consultation. Questions? Drop them below. #Microneedling #SkinHealth #NurseLedAesthetics" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "The honest no", idea: "Abi to camera, trust angle.", cap: "I will happily tell you when you do not need a treatment. That honesty is the whole reason people trust a nurse-led clinic, your skin first, never the biggest sale. #HonestAdvice #NurseLed #MedicalAesthetics" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Founding, the first 40", idea: "Founding teaser graphic, DM prompt.", cap: "Something for the first people through the Winchester door. We are capping our opening at 40 founding clients: priority booking, and founding pricing held for good. A real number are already taken. DM me FOUNDING. #Winchester #FoundingClient" },
  ]},
  { wc: "w/c 19 October", phase: "Countdown, final Bedhampton", posts: [
    { d: "Mon", place: "Post", media: "Carousel", slot: "Educate", title: "Polynucleotides explained", idea: "Plain-English slides.", cap: "The regenerative treatment everyone is asking about, explained simply: polynucleotides help your skin repair and strengthen from within. Not for everyone, and that is the point. An analysis tells us if it is right for you. #Polynucleotides #SkinHealth #HampshireSkin" },
    { d: "Wed", place: "Post", media: "Image", slot: "Human", title: "Nearly there", idea: "Shopfront and signage photo.", cap: "Nearly there. Jewry Street, Winchester, opening 2 November. This still does not feel real. #Winchester #ComingSoon" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Final Bedhampton and founding", idea: "Two-CTA graphic.", cap: "Two things this week: the free Bedhampton analysis closes 30 October, and Winchester founding places, the first 40, are filling. For your honest first step or a founding place, tap the link. #FreeSkinAnalysis #FoundingClient #Winchester" },
  ]},
  { wc: "w/c 26 October", phase: "Launch run-in", posts: [
    { d: "Mon", place: "Post", media: "Carousel", slot: "Educate", title: "A plan, not a one-off", idea: "How the analysis builds a plan.", cap: "The best results do not come from one appointment, they come from a plan. That is what the analysis builds: a step by step that fits your skin and your life. Start with the free scan. #SkinPlan #SkinHealth #NurseLed" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Opening week is here", idea: "Excited to-camera, one week to go.", cap: "This time next week, the doors open. Monday 2 November, 9A Jewry Street, Winchester. I cannot wait to welcome you. #Winchester #OpeningSoon #AbiPetersSkinClinic" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "A handful of places left", idea: "Scarcity graphic before launch.", cap: "A handful of the 40 founding places are left before we open on Monday. Priority booking and founding pricing held for good, never a discount, just first through the door. DM FOUNDING. #FoundingClient #Winchester" },
  ]},
  { wc: "w/c 2 November", phase: "LAUNCH WEEK", posts: [
    { d: "Mon", place: "Post", media: "Reel", slot: "Open", title: "We are open", idea: "Doors-open reel: the room, Abi, Jewry Street.", cap: "We are open. Abi Peters Skin Clinic is now on Jewry Street, Winchester. If you have been waiting, this is your moment. Book your place, link in bio. #Winchester #NowOpen #AbiPetersSkinClinic" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Walk through the clinic", idea: "A calm tour of the space.", cap: "Come inside. Every corner of the Winchester clinic was chosen to make you feel calm the moment you arrive. This is where your skin journey starts. #Winchester #NurseLed #SkinClinic" },
    { d: "Fri", place: "Post", media: "Image", slot: "Proof", title: "First clients and a review ask", idea: "Thank-you card (faces only with consent).", cap: "Our first Winchester clients, thank you. If I have looked after your skin, an honest Google review means the world to a brand-new clinic. Founding places are nearly gone. #Winchester #FoundingClient" },
  ]},
  ...
  { wc: "w/c 16 November", phase: "Winchester-led", posts: [
    ...
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Two weeks in, thank you", idea: "Warm to-camera, plus review nudge.", cap: "Two weeks of Winchester. Thank you for such a warm welcome. If we have looked after you, a Google review helps a new clinic more than you know. #Winchester #ThankYou" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Free analysis now at Winchester", idea: "Offer graphic, Winchester address.", cap: "The free skin analysis is now at Winchester as well, through November. Your honest first step, nothing sold on the day. Book ahead. #FreeSkinAnalysis #Winchester" },
  ]},
  { wc: "w/c 23 November", phase: "Winchester-led, Christmas teaser", posts: [
    { d: "Mon", place: "Post", media: "Carousel", slot: "Educate", title: "Which treatment do I need?", idea: "You do not have to know. The scan does.", cap: "Skin boosters, a facial, microneedling, how do you know which you need? You do not have to. That is exactly what the analysis is for. Start there. #SkinHealth #NurseLed #SkinAnalysis" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "A day in the clinic", idea: "Calm day-in-the-life.", cap: "A day in the Winchester clinic: calm, considered, honest. Exactly what I always wanted to build. #Winchester #NurseLed" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Christmas is coming", idea: "Teaser graphic for next week.", cap: "Christmas is coming, and the nicest gift is healthy skin. Vouchers and curated skincare sets land next week. #Christmas #SkincareGift" },
  ]},
  { wc: "w/c 30 November", phase: "Christmas retail", posts: [
    { d: "Mon", place: "Post", media: "Image", slot: "Educate", title: "Skincare as a gift", idea: "A gift that does something.", cap: "The gift that actually does something: medical-grade skincare, chosen properly. Our Christmas sets are non-prescription and ready to give. #ChristmasGift #Skincare" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Wrapping the gift sets", idea: "Cosy behind-the-scenes.", cap: "Wrapping up something lovely. A peek at this year's Christmas skincare sets and vouchers. #Christmas #Winchester" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Vouchers and sets live", idea: "Product graphic, link CTA.", cap: "Gift vouchers and skincare sets are here. Give healthy skin this Christmas, book or buy in the link. #ChristmasGift #SkincareSet" },
  ]},
  { wc: "w/c 7 December", phase: "Christmas retail", posts: [
    { d: "Mon", place: "Post", media: "Carousel", slot: "Educate", title: "How to use your skincare", idea: "The right order, value add.", cap: "Got skincare for Christmas, or treating yourself? Here is the order to use it in so it actually works. Little things, big difference. #Skincare #SkinHealth" },
    { d: "Wed", place: "Post", media: "Image", slot: "Human", title: "The clinic at Christmas", idea: "Festive clinic photo.", cap: "The Winchester clinic at Christmas. Thank you for a first month I will never forget. #Winchester #Christmas" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Last order dates", idea: "Deadline graphic (fill in the date).", cap: "Last chance for Christmas: order gift vouchers and skincare sets by [date] to arrive in time. Link in bio. #ChristmasGift #LastOrders" },
  ]},
  { wc: "w/c 14 December", phase: "Christmas, winding down", posts: [
    { d: "Mon", place: "Post", media: "Reel", slot: "Educate", title: "New-year skin starts with a plan", idea: "Look ahead to January.", cap: "Thinking about your skin for the new year? The best results start with a plan, not a one-off. Book a January analysis and begin properly. #SkinPlan #SkinHealth" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "Thank you and January preview", idea: "Warm to-camera, tease memberships.", cap: "As the year closes, thank you. In January we open memberships, a simple way to look after your skin all year. More soon. #Winchester #ThankYou" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Vouchers for January", idea: "Voucher graphic.", cap: "Give yourself January to look forward to. Gift vouchers work on treatments and skincare. Link in bio. #Voucher #Winchester" },
  ]},
  ...
  { wc: "w/c 12 January", phase: "New year and memberships", posts: [
    ...
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "A member's why", idea: "Member's words, with consent.", cap: "Why one of our members joined, in her words, shared with permission. This is one person's experience, everyone's skin is different. #Membership #ClientLove" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Analysis and membership", idea: "Book graphic.", cap: "Start the year with an honest look at your skin and a plan you can actually keep up. Book your analysis, link in bio. #FreeSkinAnalysis #SkinPlan #Winchester" },
  ]},
  { wc: "w/c 19 January", phase: "New year and memberships", posts: [
    { d: "Mon", place: "Post", media: "Carousel", slot: "Educate", title: "What medical-grade means", idea: "Not a marketing word.", cap: "Medical-grade is not a marketing word. It means higher actives, prescribed to your skin by a nurse and prescriber, not guessed from a shelf. That is the difference. #Skincare #NurseLed #SkinHealth" },
    { d: "Wed", place: "Post", media: "Reel", slot: "Human", title: "The year ahead", idea: "A peek at what is coming.", cap: "A peek at what is coming this year at Winchester. Bigger plans, same honesty. Follow along. #Winchester #NurseLed" },
    { d: "Fri", place: "Post", media: "Image", slot: "Offer", title: "Membership, book the analysis", idea: "Membership CTA graphic.", cap: "If you want your skin looked after all year, a membership is the simplest way. It starts with an analysis, so book yours. Link in bio. #Membership #FreeSkinAnalysis" },
  ]},
...
function Tag({ children }: { children: React.ReactNode }) {
  return <span className="text-[9px] font-bold uppercase tracking-wide rounded px-1.5 py-0.5 bg-muted-foreground/10 text-muted-foreground">{children}</span>;
}
...
export default function SocialPlan() {
  ...
  const [openWeeks, setOpenWeeks] = useState<Set<string>>(new Set([CALENDAR[0].wc]));
  const toggleWeek = (wc: string) => setOpenWeeks(prev => { const n = new Set(prev); n.has(wc) ? n.delete(wc) : n.add(wc); return n; });
  const allOpen = openWeeks.size === CALENDAR.length;
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border bg-card overflow-hidden">
        <div className="px-5 py-3.5 border-b bg-muted/[0.15] flex items-start justify-between gap-3">
          <div>
            <h3 className="text-[15px] font-bold">Content calendar, ready to post</h3>
            <p className="text-[11.5px] text-muted-foreground mt-0.5">Every Monday, Wednesday and Friday from mid September to end January. Tap a week to open it. Each post shows its place, format and category, with a finished caption. Fill in [date] and [client words] before posting.</p>
          </div>
          <button onClick={() => setOpenWeeks(allOpen ? new Set() : new Set(CALENDAR.map(w => w.wc)))} className="shrink-0 text-[11px] font-semibold text-muted-foreground hover:text-foreground border rounded-lg px-2.5 py-1.5">{allOpen ? "Collapse all" : "Expand all"}</button>
        </div>
        <div className="divide-y">
          {CALENDAR.map(wk => {
            const open = openWeeks.has(wk.wc);
            return (
              <div key={wk.wc}>
                <button onClick={() => toggleWeek(wk.wc)} className="w-full flex items-center gap-2.5 px-4 sm:px-5 py-3 hover:bg-muted/20 transition-colors text-left">
                  {open ? <ChevronDown className="w-4 h-4 text-muted-foreground shrink-0" /> : <ChevronRight className="w-4 h-4 text-muted-foreground shrink-0" />}
                  <span className="text-[13px] font-bold shrink-0" style={{ color: ACCENT }}>{wk.wc}</span>
                  <span className="text-[11px] text-muted-foreground truncate">{wk.phase}</span>
                  <span className="ml-auto text-[10px] font-semibold text-muted-foreground shrink-0 tabular-nums">{wk.posts.length} posts</span>
                </button>
                {open && (
                  <div className="px-4 sm:px-5 pb-4 space-y-2">
                    {wk.posts.map((p, i) => (
                      <div key={i} className="rounded-xl border bg-muted/15 p-3">
                        ...
                        <p className="text-[11.5px] text-muted-foreground mt-0.5 mb-1.5 italic">{p.idea}</p>
