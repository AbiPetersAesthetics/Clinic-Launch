...
export const STORED_STRATEGY: StoredStrategy = {
 ...
 "launchRationale": "Owner-final list, effective 1 November 2026: priced 4 percent below the 20km medical median per line (verified in the Market and Pricing page), except 2ml filler (cost-based, median distorted by one premium outlier) and Profhilo (fixed national price, held at 300). These are the Founding prices. The full authoritative per-site list lives in Market and Pricing.",
