...
export const STORED_STRATEGY: StoredStrategy = {
 ...
 "competitiveRead": [
  ...
  },
  {
   ...
   "read": "The real strategic threat: a nurse prescriber on the High Street pre-selling 149 per month memberships before an October opening; APA's answer was the Skin Plan ladder with a quarterly device rescan and written progress notes, which is now paused while it is reworked, so this threat is currently unanswered. Settle the reworked plan before they own the recurring-revenue client."
  }
 ],
 "risks": [
  ...
  "Winchester Medical Aesthetics hoovers up the membership market before 2 November. Guardrail: the Skin Plan is paused while it is reworked; when it returns, sell it to founding clients from their first scan rather than waiting, and hold it on the quarterly rescan and written progress notes as the differentiator their facials-only model cannot match.",
