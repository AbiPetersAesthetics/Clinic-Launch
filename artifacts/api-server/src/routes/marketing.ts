...
const P: Seed[] = [
  ...
  { phase: "p0", channel: "meta", owner: "david", week: "", title: "Switch ON the two Bedhampton ads, Cold + Warm", detail: "Re-activate the most recent Bedhampton Cold + Warm consultation campaigns. Point both at the complimentary skin analysis + 15% off offer. Warm (the 443 + page engagers) should beat the ~£17 cold CPL." },
  { phase: "p0", channel: "found", owner: "both", week: "", title: "Lock the Sep/Oct offer + Bedhampton booking calendar", detail: "Complimentary skin analysis at Bedhampton, 1 Sep-31 Oct. 15% off ANY treatment taken after the analysis (Bedhampton clients). Set the calendar + capacity so the diary can fill." },
  { phase: "p0", channel: "email", owner: "david", week: "", title: "Build the GHL nurture sequence for the 443 founding leads", detail: "You have 443 warm Winchester leads at £3.08 each. Auto SMS+email: complimentary skin analysis (15% off after) at Bedhampton now → priority Winchester booking from Nov. Move them through the Founding List pipeline." },
  ...
  { phase: "p1", channel: "email", owner: "david", week: "2026-09-01", title: "Email + SMS: complimentary analysis + 15% off, to founding list & Bedhampton clients", detail: "Relaunch the offer to everyone you have. One clear CTA: book your complimentary skin analysis at Bedhampton, 15% off any treatment after, ends 31 Oct." },
  { phase: "p1", channel: "social", owner: "both", week: "2026-09-01", title: "3 posts, theme: introduce the complimentary skin analysis", detail: "Mon authority (why a skin analysis matters) · Wed BTS (meet Abi) · Fri offer (book it, 15% off after). Abi records, David schedules." },
  ...
  { phase: "p1", channel: "email", owner: "david", week: "2026-09-29", title: "'Last month for the complimentary analysis' heads-up", detail: "Create urgency: the free analysis + 15% off closes 31 Oct. Prompts the fence-sitters to book October." },
  ...
  { phase: "p2", channel: "email", owner: "david", week: "2026-10-20", title: "'Complimentary analysis closes 31 Oct', final push", detail: "Last call to the whole list. Book now for the free analysis + 15% off before it's gone." },
